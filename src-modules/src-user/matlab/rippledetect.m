...
%load /data/loren/mkarlsso/Fra/EEG/fraeeg08-2-01
%e = eeg{8}{2}{1};
load /data/loren/mkarlsso/Fra/EEG/fraeeg08-2-29
e = eeg{8}{2}{29};
etimes = geteegtimes(e);

%load /data/loren/mkarlsso/Fra/EEG/fraripple08-2-01
%r = ripple{8}{2}{1};
load /data/loren/mkarlsso/Fra/EEG/fraripple08-2-29
r = ripple{8}{2}{29};

%load /data/loren/mkarlsso/Fra/EEG/fraeeg08-3-01
%e = eeg{8}{3}{1};

%load /data/loren/mkarlsso/Fra/EEG/fraripple08-3-01
%r = ripple{8}{3}{1};
