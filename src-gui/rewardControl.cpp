    ...
    : QDialog( parent, name, modal, fl)
{
    ...
    nrows = MIN(sysinfo.maxelectnum, 16) + 5;
    ...
    grid->addMultiCellWidget(spikeLabel, 2, 2, 0, midcol - 1);
    ...
    tetSpikeSelect = (QRadioButton **) new QRadioButton 
						*[sysinfo.maxelectnum + 1];
    tetContSelect = (QRadioButton **) new QRadioButton 
						*[sysinfo.maxelectnum + 1];
	...
	row = (i-1)%16 + 3;
	s = QString("%1").arg(i);
	tetSpikeSelect[i] = new QRadioButton(s, this, "tetSpikeSelect");
	...
	tetContSelect[i] = new QRadioButton(s, this, "tetContSelect");
